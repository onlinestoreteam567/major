...
import purposeCategoriesList from '@backend/product_purpose_categories.json';
import typeCategoriesList from '@backend/product_type_categories.json';
